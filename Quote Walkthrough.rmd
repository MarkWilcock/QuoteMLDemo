...
**Use case:**
  ...
  The bank has to quote both bid and offer prces but does not know whether counterparty is wanting to 
  buy or sell until.
  Purpose of the ML model is to predict whether quote is likely to result in a buy order or sell order 
